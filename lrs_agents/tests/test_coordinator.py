...
class TestMultiAgentCoordinator:
    ...
    def test_run_coordination(self):
        ...
        # Run coordination
        results = coordinator.run(task="Test task", max_rounds=2)
    ...
    def test_update_social_precision(self):
        ...
        world_state = {"agent_b": {"last_action": "fetch_data"}}

        result = {"tool_history": [], "precision": {}}
    ...
    def test_turn_taking(self):
        ...
        def create_tracking_agent(agent_id):
            ...
            def invoke(state):
                ...
                return {"tool_history": [], "precision": {}, "belief_state": {"completed": False}}
